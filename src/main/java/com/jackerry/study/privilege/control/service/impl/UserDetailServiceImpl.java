package com.jackerry.study.privilege.control.service.impl;

import com.jackerry.study.privilege.control.domain.Admin;
import com.jackerry.study.privilege.control.domain.Employee;
 ...
 * @description: 声明实现类，用于实现接住post传输过去的数据，并进行权限访问，从而给相应对象相应的角色，从而访问到不同的页面
